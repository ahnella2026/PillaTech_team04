...
| **Exp 10** | **3-Seed Ens** | Seed (42,123,777) 훈련 | v11s | 1024 | 50 | - | - | - | - | 진행 예정 |
| **Exp 11** | **v26n Base** | 2026.01 NMS-free 아키텍처 | v26n | 1024 | 50 | - | - | - | - | 진행 예정 |
| **Exp 12** | **DETR Base** | Transformer 기반 모델 | DETR | 1024 | 50 | - | - | - | - | 진행 예정 |
| **Exp 13** | **Hetero WBF** | v11s + v26n + DETR 융합 | Mix | Mix | - | - | - | - | - | 진행 예정 |
| **Exp 14** | **Pseudo-L** | Test 셋 Pseudo-label 재학습 | Mix | Mix | - | - | - | - | - | 진행 예정 |
| **Exp 15** | **Colab Pro** | v11m, v12-S/M 고체급 학습 | Mix | 1024 | 50 | - | - | - | - | 진행 예정 |
...
1.  **🔥 1순위 (재학습 없는 최적화 - 즉시 실행)** 
    ...
    *   **Multi-scale WBF (Exp 9, 완료)**: Exp5 `best.pt`를 640/960/1024로 추론 후 WBF로 결합.
    *   **3-Seed Ensemble (Exp 10)**: Seed를 달리한 학습 결과를 결합해 모델 분산을 줄이는 전략.
...
2.  **`train_yolov8.py`** 실행 (학습)
    * `python train_yolov8.py --config configs/exp7_train.yaml`
...
4.  **`test_custom.py`** 실행 (추론 + Config 자동 반영)
    * `python src/test_custom.py --config configs/exp8_inference.yaml`
